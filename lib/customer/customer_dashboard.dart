      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                ...
                children: [
                  Positioned(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text("Summer Collection", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                        const Text("Get 20% off with code MODA26", style: TextStyle(fontSize: 14)),
            ...
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: 16.0),
              child: Text("New Arrivals", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
            ),
